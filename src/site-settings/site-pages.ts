...
export const sitePages = {
  ...
  clothing: {
    page_title: 'Clothing - ThesisShop',
  ...
  furniture: {
    page_title: 'Furniture - ThesisShop',
  ...
  medicine: {
    page_title: 'Medicine - ThesisShop',
